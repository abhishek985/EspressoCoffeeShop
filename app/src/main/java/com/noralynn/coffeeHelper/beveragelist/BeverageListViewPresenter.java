...
import static com.noralynn.coffeeHelper.beveragelist.BeverageListActivity.BEVERAGE_LIST_MODEL_BUNDLE_KEY;
...
//    private static final String TAG = DrawableUtils.class.getSimpleName();
    ...
    private String getJsonStringFromBeveragesResourceFile() {
        ...
        try {
            ...
            Log.e("error", "Unsupported encoding! " + ENCODING_FORMAT);
        } catch (IOException e) {
            Log.e("error", "Error when attempting to read file: " + e.toString());
        }
        return null;
    }
